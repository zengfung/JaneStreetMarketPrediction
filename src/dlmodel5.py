...
def fit_model(x_train, y_train, epochs = 100, batch_size = 1024):
    ...
    ts = Sequential([
        ...
        # 3rd set of convolutional layer (128 -> 128 -> 128 -> Maxpool)
        ...
        # 4th set of convolutional layer (256 -> 256 -> 256 -> Maxpool)
        ...
        # 5th set of convolutional layer (512 -> 512 -> 512 -> Maxpool)
